...
cat(paste("Median age of a female Representative."), +
...
cat(paste("Median age of a male Representative."), +
      round(as.numeric(difftime(as.Date(Sys.Date()), as.Date(median(men$birthday[which(men$type=="rep")])), unit="weeks"))/52.25), "\n")

########################################################

# Median of a Democratic female Congressman. 
cat(paste("Median age of a Democratic female Congressman."), +
      round(as.numeric(difftime(as.Date(Sys.Date()), as.Date(median(dem[dem$gender=="F","birthday"])), unit="weeks"))/52.25), "\n")

# Median age of a Democratic female Senator.
cat(paste("Median age of a Democratic female Senator."), +
      round(as.numeric(difftime(as.Date(Sys.Date()), as.Date(median(women$birthday[which(women$type=="sen") && women$party=="Democrat"])), unit="weeks"))/52.25), "\n")

# Median age of a Democratic female Representative.
cat(paste("Median age of a Democratic female Representative."), +
      round(as.numeric(difftime(as.Date(Sys.Date()), as.Date(median(women$birthday[which(women$type=="rep") && women$party=="Democrat"])), unit="weeks"))/52.25), "\n")

########################################################

# Median of a Democratic male Congressman. 
cat(paste("Median age of a Democratic male Congressman."), +
      round(as.numeric(difftime(as.Date(Sys.Date()), as.Date(median(dem[dem$gender=="M","birthday"])), unit="weeks"))/52.25), "\n")

# Median age of a Democratic male Senator.
cat(paste("Median age of a Democratic male Senator."), +
      round(as.numeric(difftime(as.Date(Sys.Date()), as.Date(median(men$birthday[which(men$type=="sen") && men$party=="Democrat"])), unit="weeks"))/52.25), "\n")

# Median age of a Democratic male Representative.
cat(paste("Median age of a Democratic male Representative."), +
      round(as.numeric(difftime(as.Date(Sys.Date()), as.Date(median(men$birthday[which(men$type=="rep") && men$party=="Democrat"])), unit="weeks"))/52.25), "\n")

########################################################
# ************************ TODO ************************

# Median of a Republican female Congressman. 
cat(paste("Median age of a Republican female Congressman."), +
      round(as.numeric(difftime(as.Date(Sys.Date()), as.Date(median(repub[repub$gender=="F","birthday"])), unit="weeks"))/52.25), "\n")

# Median age of a Republican female Senator.
cat(paste("Median age of a Republican female Senator."), +
      round(as.numeric(difftime(as.Date(Sys.Date()), as.Date(median(women$birthday[which(women$type=="sen") && women$party=="Republican"])), unit="weeks"))/52.25), "\n")

# Median age of a Republican female Representative.
cat(paste("Median age of a Republican female Representative."), +
      round(as.numeric(difftime(as.Date(Sys.Date()), as.Date(median(women$birthday[which(women$type=="rep") && women$party=="Republican"])), unit="weeks"))/52.25), "\n")

########################################################
# ************************ TODO ************************
# Median of a Republican male Congressman. 
cat(paste("Median age of a Republican male Congressman."), +
      round(as.numeric(difftime(as.Date(Sys.Date()), as.Date(median(repub[repub$gender=="M","birthday"])), unit="weeks"))/52.25), "\n")

# Median age of a Republican male Senator.
cat(paste("Median age of a Republican male Senator."), +
      round(as.numeric(difftime(as.Date(Sys.Date()), as.Date(median(men$birthday[which(men$type=="sen") && men$party=="Republican"])), unit="weeks"))/52.25), "\n")

# Median age of a Republican male Representative.
cat(paste("Median age of a Republican male Representative."), +
      round(as.numeric(difftime(as.Date(Sys.Date()), as.Date(median(men$birthday[which(men$type=="rep") && men$party=="Republican"])), unit="weeks"))/52.25), "\n")
